...
export default function CsvUploadModal({ school, onClose, onSuccess }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-900/40 backdrop-blur-xs animate-fadeIn overflow-y-auto">
      <div className="bg-white border border-slate-200 rounded-2xl max-w-xl w-full p-4 sm:p-6 shadow-xl relative text-slate-900 my-auto max-h-[90vh] overflow-y-auto">
        <button
          onClick={onClose}
